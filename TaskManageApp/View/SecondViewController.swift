...
class SecondViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
   ...
   // @IBOutlet var priotityPickerView: UIPickerView!
   // @IBOutlet var genrePickerView: UIPickerView!
    ...
    func hantei(){
        ...
        if priorityTextField == nil {
            alert()
        }
        
        if genreTextField == nil {
            alert()
        }
    }
    ...
    func alert(){
        ...
        let alert: UIAlertController = UIAlertController(title: "エラー", message: "空欄部分があります", preferredStyle:  UIAlertController.Style.alert)
